      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="space-y-8">
          {[
            ...
            { title: "8. Autonomous Smart Contracts", content: "We do not directly administer or participate in the Platform's autonomous smart contract operations besides providing the initial code. Transactions occur automatically with no interference ability." },
            ...
            { title: "9. Agreement", content: "By using this Platform, you accept the most current vesion ofthese Terms of Use." },
