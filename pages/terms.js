      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="space-y-8">
          {[
            ...
            { title: "4. AML/KYC Verification", content: "4.1. All users must complete anti-money laundering (AML) and know your customer (KYC) checks through our approved vendor. 4.2. You specifically confirm that you have completed this verification successfully. 4.3. To complete verification, follow the instructions provided on our KYC/AML page [link to page]. 4.4. Failure to successfully verify identity and funds will result in immediate account suspension and may lead to permanent denial of Platform access." },
            ...
            { title: "13. Limitation of Liability", content: "Under no circumstances, including negligence, shall the owners/operators/developers be liable for damages related to smart contract operations, bugs, hacks, failures or disruptions. Use indicates your agreement that liability is limited to the fullest extent under Estonian law.  There is no end date to this clause." },
